...
namespace TALXIS.TestKit.Selectors
{
    ...
    public class Field
    {
        ...
        public bool IsReadOnly
        {
            get
            {
                if (containerElement.HasElement(FieldElementsLocators.ReadOnly))
                {
                    var readOnly = containerElement.FindElement(FieldElementsLocators.ReadOnly);
        ...
        public bool IsRequired
        {
            get
            {
                if (containerElement.HasElement(FieldElementsLocators.RequiredIcon))
                {
                    var required = containerElement.FindElement(FieldElementsLocators.RequiredIcon);
