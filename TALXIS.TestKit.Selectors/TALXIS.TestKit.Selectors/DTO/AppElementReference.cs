...
namespace TALXIS.TestKit.Selectors
{
    public static class AppReference
    {
        ...
        public static class Entity
        {
            ...
            public static string EntityNewLookOptionsetStatusCombo = "Entity_NewLookOptionsetStatusCombo";
            public static string EntityNewLookOptionsetStatusComboButton = "Entity_NewLookOptionsetStatusComboButton";
            public static string EntityNewLookOptionsetStatusComboList = "Entity_NewLookOptionsetStatusComboList";
            public static string EntityOldLookOptionsetStatusCombo = "Entity_OldLookOptionsetStatusCombo";
            public static string EntityOldLookOptionsetStatusComboButton = "Entity_OldLookOptionsetStatusComboButton";
            public static string EntityOldLookOptionsetStatusComboList = "Entity_OldLookOptionsetStatusComboList";
        ...
        public static class Field
        {
            ...
            public static string LableSearch = "Field_LableSearch";
            public static string IndexSearch = "Field_LableSearch";
        }
    ...
    public static class AppElements
    {
        public static Dictionary<string, string> Xpath = new Dictionary<string, string>()
        {
            ...
            { "Entity_NewLookOptionsetStatusCombo", "//div[contains(@class, 'fui-Dropdown')]"},
            { "Entity_NewLookOptionsetStatusComboButton", "//button[contains(@data-id, '[NAME].fieldControl-option-set-select')]"},
            { "Entity_NewLookOptionsetStatusComboList", "//div[contains(@class, 'fui-Listbox')]"},
            { "Entity_OldLookOptionsetStatusCombo", "//div[contains(@data-id, '[NAME].fieldControl-pickliststatus-comboBox')]"},
            { "Entity_OldLookOptionsetStatusComboButton", "//div[contains(@id, '[NAME].fieldControl-pickliststatus-comboBox_button')]"},
            { "Entity_OldLookOptionsetStatusComboList", "//ul[contains(@id, '[NAME].fieldControl-pickliststatus-comboBox_list')]"},
            ...
            {"Field_LableSearch", "//label[contains(text(), '[LABLE]')]/following::*[self::input or self::textarea or self::div][1]" },
            {"Field_IndexSearch", "//input | //textarea | //div[contains(@class, 'control')]" },
