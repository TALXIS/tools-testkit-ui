...
namespace TALXIS.TestKit.Selectors
{
    ...
    public class Timeline : Element
    {
        ...
        {
            _timelineManager.OpenAndClickPopoutMenu(Reference.Timeline.Popout, Reference.Timeline.PopoutAppointment, 4000);
            _timelineManager.Client.ThinkTime(4000);
            SetValueHelper.SetTextFieldValue(_timelineManager.Client, Elements.ElementId[Reference.Timeline.AppointmentSubject], subject, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_timelineManager.Client, Elements.ElementId[Reference.Timeline.AppointmentLocation], location, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_timelineManager.Client, Elements.ElementId[Reference.Timeline.AppointmentDescription], description, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_timelineManager.Client, Elements.ElementId[Reference.Timeline.AppointmentDuration], duration, FormContextType.QuickCreate);
        }

        public void ClickCreateOnTimeline(string activityName)
        {
            _timelineManager.ClickCreateOnTimeline(activityName);
        }
        ...
        {
            _timelineManager.ClickButton(AppElements.Xpath[AppReference.QuickCreate.SaveAndCloseButton].Replace("[NAME]", Elements.ElementId[activity]));
        }
        ...
        {
            _timelineManager.OpenAndClickPopoutMenu(Reference.Timeline.Popout, Reference.Timeline.PopoutEmail, 4000);
        }
        ...
        {
            SetValueHelper.SetTextFieldValue(_entityManager.Client,Elements.ElementId[Reference.Timeline.EmailSubject], subject);
        }
        ...
        {
            SetValueHelper.SetValue(_entityManager.Client, toOptions, FormContextType.Entity, removeExistingValues);
        }
        ...
        {
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.EmailDuration], duration);
        }
        ...
        {
            return _entityManager.GetValue(emailOptions);
        }
        ...
        {
            return _entityManager.ClearValue(emailOptions, FormContextType.Entity);
        ...
        public void SaveAndCloseEmail()
        {
            ...
            _commandBarManager.ClickCommand("Save & Close");
        ...
        {
            _timelineManager.OpenAndClickPopoutMenu(Reference.Timeline.Popout, Reference.Timeline.PopoutPhoneCall, 4000);
            _timelineManager.Client.ThinkTime(4000);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.PhoneCallSubject], subject, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.PhoneCallNumber], phoneNumber, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.PhoneCallDescription], description, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.PhoneCallDuration], duration, FormContextType.QuickCreate);
        }
        ...
        {
            _timelineManager.OpenAndClickPopoutMenu(Reference.Timeline.Popout, Reference.Timeline.PopoutTask, 4000);
            _timelineManager.Client.ThinkTime(4000);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.TaskSubject], subject, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.TaskDescription], description, FormContextType.QuickCreate);
            SetValueHelper.SetTextFieldValue(_entityManager.Client, Elements.ElementId[Reference.Timeline.TaskDuration], duration, FormContextType.QuickCreate);
        }
        ...
        {
            _timelineManager.OpenAndClickPopoutMenu(Reference.Timeline.Popout, Reference.Timeline.PopoutPost, 4000);
            SetValueHelper.SetValue(_timelineManager.Client,Reference.Timeline.PostText, text, "textarea");
            _timelineManager.ClickButton(Elements.Xpath[Reference.Timeline.PostAdd]);
        }
        ...
        {
            _timelineManager.OpenAndClickPopoutMenu(Reference.Timeline.Popout, Reference.Timeline.PopoutNote, 4000);
            SetValueHelper.SetValue(_timelineManager.Client, Reference.Timeline.NoteTitle, title, "input");
            SetValueHelper.SetValue(_timelineManager.Client, Reference.Timeline.NoteText, note, "iframe");
            _timelineManager.ClickButton(Elements.Xpath[Reference.Timeline.NoteAdd]);
        }
    }
}
